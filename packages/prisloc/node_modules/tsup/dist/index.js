...
var _chunk4FJ6UJ7Ejs = require('./chunk-4FJ6UJ7E.js');
...
var require_consola = _chunkJIBD5LVIjs.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkJIBD5LVIjs.__require.call(void 0, "util"));
    var e = _chunkJIBD5LVIjs.__require.call(void 0, "path");
    var t = _chunkJIBD5LVIjs.__require.call(void 0, "fs");
    var r = u(_chunkJIBD5LVIjs.__require.call(void 0, "os"));
    var n = u(_chunkJIBD5LVIjs.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var Gu = "undefined" != typeof __non_webpack_require__ ? __non_webpack_require__ : _chunkJIBD5LVIjs.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async () => {
        const loadConfig = _chunkJIBD5LVIjs.__require.call(void 0, "postcss-load-config");
        if (configCache) {
          return configCache;
        }
        try {
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins && plugins.length > 0) {
          const postcss = _chunkJIBD5LVIjs.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkJIBD5LVIjs.localRequire.call(void 0, "svelte/compiler");
        sveltePreprocessor = sveltePreprocessor || _chunkJIBD5LVIjs.localRequire.call(void 0, "svelte-preprocess");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkJIBD5LVIjs.__toESM.call(void 0, require_consola());
...
var swcPlugin = ({ logger }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkJIBD5LVIjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        logger.warn(
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkJIBD5LVIjs.__require.resolve(args.path, {
...
var getOutputExtensionMap = (options, format, pkgType) => {
  const outExtension = options.outExtension || _chunkJIBD5LVIjs.defaultOutExtension;
  const defaultExtension = _chunkJIBD5LVIjs.defaultOutExtension.call(void 0, { format, pkgType });
...
var generateExternal = async (external) => {
  ...
  for (const item of external) {
    ...
    const deps = await _chunkRCPHI5E7js.getProductionDeps.call(void 0, pkgPath);
    result.push(...deps);
  }
  return result;
};
async function runEsbuild(options, {
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      plugins: esbuildPlugins.filter(_chunkJIBD5LVIjs.truthy),
      define: {
  ...
  if (result && result.warnings && !_chunkRCPHI5E7js.getSilent.call(void 0, )) {
...
var swcTarget = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkJIBD5LVIjs.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkXAZYDLXKjs.PrettyError)(
...
var isInPublicDir = (publicDir, filePath) => {
  if (!publicDir)
    return false;
  const publicPath = _chunkJIBD5LVIjs.slash.call(void 0, 
    _path2.default.resolve(publicDir === true ? "public" : publicDir)
  );
  return _chunkJIBD5LVIjs.slash.call(void 0, _path2.default.resolve(filePath)).startsWith(`${publicPath}/`);
};
  ...
  return {
    ...
    async renderChunk(code, info) {
      if (minifyOptions !== "terser" || !/\.(cjs|js|mjs)$/.test(info.path))
        return;
      const terser = _chunkJIBD5LVIjs.localRequire.call(void 0, "terser");
      if (!terser) {
        throw new (0, _chunkXAZYDLXKjs.PrettyError)(
...
var normalizeOptions = async (logger, optionsFromConfigFile, optionsOverride) => {
  ...
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkXAZYDLXKjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkXAZYDLXKjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkXAZYDLXKjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    throw new (0, _chunkXAZYDLXKjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  if (!options.target) {
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkRCPHI5E7js.loadTsupConfig.call(void 0, 
    process.cwd(),
  ...
  await Promise.all(
    [...Array.isArray(configData) ? configData : [configData]].map(
      async (item) => {
        const logger = _chunkRCPHI5E7js.createLogger.call(void 0, _optionalChain([item, 'optionalAccess', _27 => _27.name]));
        const options = await normalizeOptions(logger, item, _options);
        logger.info("CLI", `tsup v${_chunk4FJ6UJ7Ejs.version}`);
        if (config.path) {
        ...
        const mainTasks = async () => {
          if (!_optionalChain([options, 'access', _29 => _29.dts, 'optionalAccess', _30 => _30.only])) {
            ...
            let depsHash = await _chunkRCPHI5E7js.getAllDepsHash.call(void 0, process.cwd());
            ...
            const debouncedBuildAll = _chunkJIBD5LVIjs.debouncePromise.call(void 0, 
              () => {
                return buildAll();
              },
              100,
              _chunkXAZYDLXKjs.handleError
            );
            const buildAll = async () => {
              ...
              if (options.clean) {
                ...
                await _chunkJIBD5LVIjs.removeFiles.call(void 0, ["**/*", ...extraPatterns], options.outDir);
            ...
            const startWatcher = async () => {
              ...
              watcher.on("all", async (type, file) => {
                file = _chunkJIBD5LVIjs.slash.call(void 0, file);
                ...
                if (options.watch === true) {
                  if (file === "package.json" && !buildDependencies.has(file)) {
                    const currentHash = await _chunkRCPHI5E7js.getAllDepsHash.call(void 0, process.cwd());
