...
var loadJson = async (filepath) => {
  try {
    return _chunkJIBD5LVIjs.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
var colorize = (type, data, onlyImportant = false) => {
  ...
  return _chunkXAZYDLXKjs.colorette_exports[color](data);
};
var makeLabel = (name, input, type) => {
  return [
    name && `${_chunkXAZYDLXKjs.dim.call(void 0, "[")}${name.toUpperCase()}${_chunkXAZYDLXKjs.dim.call(void 0, "]")}`,
...
var reportSize = (logger, format, files) => {
  ...
  for (const name of filenames) {
    logger.success(
      format,
      `${_chunkXAZYDLXKjs.bold.call(void 0, padRight(name, maxLength))}${_chunkXAZYDLXKjs.green.call(void 0, 
